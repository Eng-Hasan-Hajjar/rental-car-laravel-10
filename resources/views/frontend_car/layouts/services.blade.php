<div class="container-fluid py-5"   style="direction:rtl" >
    <div class="container pt-5 pb-3" style="direction:rtl">
        <h1 class="display-1 text-primary text-center">02</h1>
        <h1 class="display-4 text-uppercase text-center mb-5">   خدماتنا  </h1>
        <div class="row" style="direction:rtl">
            <div class="col-lg-4 col-md-6 mb-2"style="direction:rtl">
